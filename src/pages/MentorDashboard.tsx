...
const MentorDashboard: React.FC = () => {
  ...
  return (
    <section className="bg-gray-50 mt-20 min-h-screen p-6">
      <div className="max-w-5xl bg-amber-500  mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-white p-6 rounded shadow">
            ...
            <p className="text-3xl text-cyan-600 font-bold">{totalMentees}</p>
          </div>
          <div className="bg-white p-6 rounded shadow">
