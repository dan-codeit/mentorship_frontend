...
const About: React.FC = () => {
  return (
    <section className="bg-white min-h-svh text-gray-800 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-center">About Danitors</h1>

        <p className="text-lg mb-8 text-center max-w-3xl mx-auto">
          Danitors is a platform designed to connect mentees with experienced
        ...
        <div className="grid md:grid-cols-1 gap-10">
          <div>
            <h2 className="text-2xl font-semibold mb-2">
              Why Danitors Matters
            </h2>
            <p className="text-gray-700 mb-4">
              Danitors can accelerate personal and professional growth. Whether
              you're a student seeking guidance or a professional looking to
              give back, a strong mentor-mentee relationship can make a lasting
              impact.
            </p>
